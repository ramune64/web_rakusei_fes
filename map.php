...
<body>
  ...
  <div class="over_view_box" id="ovh1b">
    ...
    <div class="main_content">
        ...
        <div id="rakusei_map_28124" align=center x:publishsource="Excel">

<table border=1 cellpadding=0 cellspacing=0 style='table-layout:fixed;border-style:none;height:150px'>
 <col width=16 span=22 style='width:20px'>
 ...
 <col width=8 span=8 style='mso-width-source:userset;mso-width-alt:256;
 width:10px'>
 <col width=16 span=10 style='width:20px'>
 ...
 <tr height=0 style='display:none'>
  <td width=16 style='width:20px'></td>
  <td width=16 style='width:20px'></td>
  <td width=16 style='width:20px'></td>
  <td width=16 style='width:20px'></td>
  <td width=16 style='width:20px'></td>
