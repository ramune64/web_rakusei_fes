...
$event_list = [[   [["s_time"=> "8:30","f_time"=> "9:00","title"=> "開会式","txt"=> "始まりの合図"],
                    ["s_time"=> "9:30","f_time"=> "11:45","title"=> "中学合唱","txt"=> "合唱順は後ほど発表"],
                    ...
                    ["s_time"=> "11:00","f_time"=> "14:00","title"=> "昼食会場","txt"=> "生徒専用の昼食会場 <u><br>生徒のみ利用可</br></u> "],
                    ["s_time"=> "14:00","f_time"=> "16:00","title"=> "映像コンテスト","txt"=> "生徒自作の映像を見よう"]],//d1p3
                ...
                [
                    ...
                    [["s_time"=> "11:00","f_time"=> "12:30","title"=> "ライブ会場","txt"=> ""],
                    ["s_time"=> "13:30","f_time"=> "15:30","title"=> "ライブ会場","txt"=> ""]],//d2p2
                    ...
                    ["s_time"=> "12:00","f_time"=> "13:00","title"=> "弾き語り","txt"=> ""],
                    ...
                    [["s_time"=> "9:00","f_time"=> "10:45","title"=> "映像コンテスト","txt"=> "生徒自作の映像を見よう！"],
                    ["s_time"=> "11:00","f_time"=> "14:00","title"=> "昼食会場","txt"=> "生徒専用の昼食会場 <u><br>在校生徒のみ利用可</br></u>"],
                    ["s_time"=> "14:00","f_time"=> "15:45","title"=> "映像コンテスト","txt"=> "生徒自作の映像をみよう！"]],//d2p8
                ...
                [
                    ...
                    ["s_time"=> "12:00","f_time"=> "13:45","title"=> "映像コンテスト","txt"=> "生徒自作の映像を見よう 最終編"]],//d3p4
