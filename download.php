                ...
                <section class="Download_Section">
                    ...
                    <div class="Pamphlet">
                        ...
                        <div class="Download_intro item">
                            <h3>説明</h3>
                            <p>第73回洛星文化祭～宴～<br>のパンフレットです！<br>プログラムパートが一生懸命作った集大成なので、文化祭来る前や文化祭まわってる間などにお使いください！！<!-- <br>試し読みは<a href="pamphlet.php">こちら</a> --></p>
                        ...
                        <div class="Row Left">
                            <div class="Each_Club" id="club1">
                                <div class="Up_content">
                                    <a href='javascript:magazine("club1")'><img src="image/logo.png" alt="logo" class="Club_logo"><h3>準備中</h3><img src="image/up_arrow.png" alt="" id="arrow" class="Arrow"></a>
                                </div>
                                <div>
                                <section>
                                    <h4>準備中</h4>
