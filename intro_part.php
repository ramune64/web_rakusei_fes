    ...
    <div class="wrap">
        ...
        <div class="main_content">
            	<div class="inner_content inner_top intro_part" id="intro_part">
                    ...
                    <div class="part" style="background-color: black;">
                        ...
                        <p class="Pl_name">PL.洛星太郎</p>
                    </div>
                    <div class="part" style="background-color: gray;">
                        <h2>執行パート</h2>
                    ...
                    <div class="part" style="background-color: #30D5C8;">
                        <h2>合唱パート</h2>
                    ...
                    <div class="part">
                        <h2>展示パート</h2>
                        <p>各展示団体と協力してより良い展示を作り上げます。</p>
                    </div>
                    <div class="part">
                        <h2>バザーパート</h2>
                        <p>生徒バザーの準備・開催をしているパートです。当日はｘｘで行っているのでぜひ来てください。</p>
                    </div>
                    <div class="part">
                        <h2>模擬店パート</h2>
                    ...
                    <div class="part">
                        <h2>ライブパート</h2>
                        <p>文化祭といえばライブでしょ！各ライブ団体の管理及び指揮を行っています。ぜひ足を運んでください。</p>
                    </div>
                    <div class="part">
                        <h2>アミューズパート</h2>
                    ...
                    <div class="part">
                        <h2>プログラムパート</h2>
                        <p>今あなたの持っている素晴らしいパンフレットを作成するパートです。<br>パンフレットのデータは<a href="download.php">こちら</a>からもご確認できます。</p>
                    </div>
                    <div class="part">
                        <h2>装飾パート</h2>
                        <p>校内の階段・天井・壁などの装飾を担当しています。絵のうまい下手は気にせず、温かい目で見てくれればと思います。</p>
                    </div>
                    <div class="part">
                        <h2>会計パート</h2>
                        <p>元弓と呼ばれる大講堂下倉庫で道具の貸し出しを行っています。また、予算の申請と決算を行っています。</p>
                    </div>
                    <div class="part">
                        <h2>ラジオパート</h2>
